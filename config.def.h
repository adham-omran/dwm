...
static const char *volume_up_cmd[] = {"wpctl", "set-volume", "@DEFAULT_AUDIO_SINK@", "2%+"};
static const char *volume_down_cmd[] = {"wpctl", "set-volume", "@DEFAULT_AUDIO_SINK@", "2%-"};
static const char *volume_mute_cmd[] = {"wpctl", "set-mute", "@DEFAULT_AUDIO_SINK@", "toggle"};
static const char *volume_mute_mic_cmd[] = {"wpctl", "set-mute", "@DEFAULT_SOURCE@", "toggle"};
...
static const Key keys[] = {
  ...
  { MODKEY,                       XK_comma,  focusmon,       {.i = +1 } }, /* Move to another monitor */
  { MODKEY,                       XK_period, focusmon,       {.i = -1 } },
  { MODKEY|ShiftMask,             XK_comma,  tagmon,         {.i = +1 } }, /* Move window to another monitor */
